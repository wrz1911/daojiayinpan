...
tyme.ChildLimit = tyme.LunarSect2ChildLimitProvider = tyme.LunarSect1ChildLimitProvider = tyme.China95ChildLimitProvider = tyme.DefaultChildLimitProvider = tyme.AbstractChildLimitProvider = tyme.ChildLimitInfo = tyme.EightChar = tyme.LunarFestival = tyme.SolarFestival = tyme.AbstractFestival = tyme.LegalHoliday = tyme.SolarTime = tyme.SolarDay = tyme.SolarWeek = tyme.SolarMonth = tyme.SolarSeason = tyme.SolarHalfYear = tyme.SolarYear = tyme.SolarTermDay = tyme.SolarTerm = tyme.ShouXingUtil = tyme.JulianDay = tyme.LunarHour = tyme.LunarSect2EightCharProvider = tyme.DefaultEightCharProvider = tyme.ThreePillars = tyme.SixtyCycleHour = tyme.SixtyCycleDay = tyme.SixtyCycleMonth = tyme.SixtyCycleYear = tyme.LunarDay = tyme.LunarWeek = tyme.LunarMonth = tyme.FetusMonth = tyme.LunarSeason = tyme.LunarYear = tyme.Ecliptic = tyme.TwelveStar = tyme.NineStar = tyme.PhenologyDay = tyme.Dipper = tyme.ThreePhenology = tyme.Phenology = tyme.NineDay = tyme.Nine = tyme.FetusDay = tyme.FetusEarthBranch = tyme.FetusHeavenStem = tyme.PlumRainDay = void 0;
tyme.EventManager = tyme.Event = tyme.HijriDay = tyme.HijriMonth = tyme.HijriYear = tyme.RabByungDay = tyme.RabByungMonth = tyme.RabByungYear = tyme.RabByungElement = tyme.KitchenGodSteed = tyme.Fortune = tyme.DecadeFortune = void 0;
var YinYang;
(function (YinYang) {
    YinYang[YinYang["YIN"] = 0] = "YIN";
    YinYang[YinYang["YANG"] = 1] = "YANG";
})(YinYang || (tyme.YinYang = YinYang = {}));
var Side;
(function (Side) {
    Side[Side["IN"] = 0] = "IN";
    Side[Side["OUT"] = 1] = "OUT";
...
})(HideHeavenStemType || (tyme.HideHeavenStemType = HideHeavenStemType = {}));
var EventType;
(function (EventType) {
...
})(EventType || (tyme.EventType = EventType = {}));
...
tyme.AbstractCulture = AbstractCulture;
class AbstractTyme extends AbstractCulture {
}
tyme.AbstractTyme = AbstractTyme;
...
tyme.WeekUnit = WeekUnit;
WeekUnit.NAMES = ['第一周', '第二周', '第三周', '第四周', '第五周', '第六周'];
...
tyme.AbstractCultureDay = AbstractCultureDay;
...
tyme.TwentyEightStar = TwentyEightStar;
...
tyme.Constellation = Constellation;
...
class Phase extends LoopTyme {
    ...
    getStartSolarTime() {
        ...
        const t = ShouXingUtil.msaLonT((n + i + r[~~(this.getIndex() / 2)] / 360.0) * ShouXingUtil.PI_2) * 36525;
...
tyme.HideHeavenStem = HideHeavenStem;
...
tyme.HideHeavenStemDay = HideHeavenStemDay;
...
tyme.PengZuHeavenStem = PengZuHeavenStem;
...
tyme.PengZuEarthBranch = PengZuEarthBranch;
...
tyme.FetusHeavenStem = FetusHeavenStem;
...
tyme.FetusEarthBranch = FetusEarthBranch;
...
class Phenology extends LoopTyme {
    ...
    getJulianDay() {
        const t = ShouXingUtil.saLonT((this.year - 2000 + (this.getIndex() - 18) * 5.0 / 360 + 1) * 2 * Math.PI);
        return JulianDay.fromJulianDay(t * 36525 + JulianDay.J2000 + 8.0 / 24 - ShouXingUtil.dtT(t * 36525));
    }
}
tyme.Phenology = Phenology;
...
tyme.ThreePhenology = ThreePhenology;
...
tyme.PhenologyDay = PhenologyDay;
...
tyme.NineStar = NineStar;
NineStar.NAMES = ['一', '二', '三', '四', '五', '六', '七', '八', '九'];
NineStar.COLORS = ['白', '黑', '碧', '绿', '黄', '白', '赤', '白', '紫'];
...
tyme.SixtyCycleYear = SixtyCycleYear;
...
tyme.SixtyCycleMonth = SixtyCycleMonth;
...
tyme.SixtyCycleDay = SixtyCycleDay;
...
tyme.SixtyCycleHour = SixtyCycleHour;
...
tyme.ThreePillars = ThreePillars;
class DefaultEightCharProvider {
    getEightChar(hour) {
        return hour.getSixtyCycleHour().getEightChar();
    }
}
tyme.DefaultEightCharProvider = DefaultEightCharProvider;
...
tyme.LunarSect2EightCharProvider = LunarSect2EightCharProvider;
...
class ShouXingUtil {
    ...
    static mv(t) {
        const v = 8399.71 - 914 * Math.sin(0.7848 + 8328.691425 * t + 0.0001523 * t * t);
...
tyme.ShouXingUtil = ShouXingUtil;
...
class SolarTerm extends LoopTyme {
    constructor(year, indexOrName) {
        ...
        const jd = Math.floor((y - 2000) * 365.2422 + 180);
...
tyme.SolarTermDay = SolarTermDay;
...
tyme.SolarHalfYear = SolarHalfYear;
...
tyme.LegalHoliday = LegalHoliday;
...
tyme.AbstractFestival = AbstractFestival;
...
tyme.SolarFestival = SolarFestival;
SolarFestival.NAMES = ['元旦', '妇女节', '植树节', '劳动节', '青年节', '儿童节', '建党节', '建军节', '教师节', '国庆节'];
SolarFestival.DATA = '0VV__0Ux0Xc__0Ux0Xg__0_Q0ZV__0Ux0ZY__0Ux0aV__0Ux0bV__0Uo0cV__0Ug0de__0_V0eV__0Ux';
...
tyme.LunarFestival = LunarFestival;
LunarFestival.NAMES = ['春节', '元宵节', '龙头节', '上巳节', '清明节', '端午节', '七夕节', '中元节', '中秋节', '重阳节', '冬至节', '腊八节', '除夕'];
LunarFestival.DATA = '2VV__0002Vj__0002WW__0002XX__0003b___0002ZZ__0002bb__0002bj__0002cj__0002dd__0003s___0002gc__0002hV_U000';
...
tyme.ChildLimitInfo = ChildLimitInfo;
...
tyme.AbstractChildLimitProvider = AbstractChildLimitProvider;
...
tyme.DefaultChildLimitProvider = DefaultChildLimitProvider;
...
tyme.China95ChildLimitProvider = China95ChildLimitProvider;
...
tyme.LunarSect1ChildLimitProvider = LunarSect1ChildLimitProvider;
...
tyme.LunarSect2ChildLimitProvider = LunarSect2ChildLimitProvider;
class ChildLimit {
...
tyme.DecadeFortune = DecadeFortune;
...
tyme.KitchenGodSteed = KitchenGodSteed;
...
tyme.RabByungElement = RabByungElement;
RabByungElement.NAMES = ['木', '火', '土', '铁', '水'];
...
tyme.RabByungYear = RabByungYear;
...
tyme.RabByungMonth = RabByungMonth;
RabByungMonth.DAYS = {};
...
tyme.HijriMonth = HijriMonth;
HijriMonth.NAMES = ['穆哈兰姆月', '色法尔月', '赖比尔·敖外鲁月', '赖比尔·阿色尼月', '主马达·敖外鲁月', '主马达·阿色尼月', '赖哲卜月', '舍尔邦月', '赖买丹月', '闪瓦鲁月', '都尔喀尔德月', '都尔黑哲月'];
...
tyme.HijriDay = HijriDay;
HijriDay.NAMES = ['1日', '2日', '3日', '4日', '5日', '6日', '7日', '8日', '9日', '10日', '11日', '12日', '13日', '14日', '15日', '16日', '17日', '18日', '19日', '20日', '21日', '22日', '23日', '24日', '25日', '26日', '27日', '28日', '29日', '30日'];
...
tyme.EventManager = EventManager;
