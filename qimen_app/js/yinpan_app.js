...
const XN_HELP = {
  ...
  blocks: [
    { t: '引言', rows: [
      '<b style="color:var(--c-gold)">这是一门什么</b>',
      '<b>它是一圈排在奇门盘外面的盘。</b>',
      '原有的奇门局照旧起、照旧看；在这个局的外面，沿十二地支再铺一圈字——<b>这一圈字就是"外盘"</b>。',
      '<b>它不是另一门术数，是奇门的外挂</b>：盘里原有的信息一条不少，外盘在旁边再给你一层信息。断局时两下合看，取象更快、更直接；布局时用它挑方位、挑时间，也多一层依据。',
      '<b>它不挑盘</b> —— 阴盘、阳盘都能用。所以不必纠结自己学的是哪一派，把它当工具即可。它还可以和别的技法叠用：做法事时用它选时辰方位，平时已有的断卦、布局方法也照样叠加。',
      '<b style="color:var(--c-gold)">正名</b>',
      '市面上叫它"玄女诀"，但<b>这个名字是后人起的</b>。',
      '<b>这十六个字实际出自太乙</b>，正确的名字应当是<b>太乙十六字诀</b>。',
      '<b style="color:var(--c-gold)">世面上的残版</b>',
      '<b>流传在外的版本是残缺的</b>：',
      '只传了<b>十二个字</b>；',
      '这十二个字里，<b>有两个被改动过</b>；',
      '<b>另外四个字根本没有</b>；',
      '<b>排法也不全</b> —— 残版把阴遁、阳盘都作顺排，这是错的（正法是<b>阳顺阴逆</b>）。',
      '<b>正确的十二字是</b>：',
      '<b>进　曲　狱　丰　空　泣　欹　劫　散　破　灵　吾</b>',
      '<b>另有四字排在四维宫</b>：',
      '<b>雷　火　风　豹</b>',
      '<b style="color:var(--c-gold)">心态</b>',
      '<b>不要把它神化。</b>',
      '任何术数都没有百分之百 —— 预测没有百分百准，做法事也没有百分百成，布局同样如此。<b>只要大部分的布局是成功的，这个方法就是好的。</b> 神仙下凡也做不到事事必应。',
      '人生该经历的还是要经历，我们能做的是<b>逢凶化吉、趋吉避凶</b>，让运势顺一些。<b>布局要符合现实、符合常理</b>，心态放平。',
      '---',
    ]},
    { t: '第一节　排法', rows: [
      '<b style="color:var(--c-gold)">一、先记住地支在九宫的位置</b>',
      '排外盘之前，先把十二地支落在九宫里的位置记牢：',
      '<code>`</code>',
      '（东南）巳　　午　　未（西南）',
      '辰　　　　　　申',
      '（东）　卯　　　　　　酉（西）',
      ...
      '（北）',
      '<code>`</code>',
      '<b>这个位置永远不变</b> —— 学会之后，一辈子都不用再改。',
      '<b style="color:var(--c-gold)">二、第一种排法：按月</b>',
      '口诀是：',
      '<b>正五九月虎当头，二六十月被猪伤，</b>',
      '<b>三七十一蛇反复，四八十二在龙江。</b>',
      '逐月对照：',
      '| 月份 | 起点 | 归属 |',
      '|---|---|---|',
      '| <b>正月、五月、九月</b> | <b>寅</b>（虎） | 寅午戌月 |',
      '| <b>二月、六月、十月</b> | <b>亥</b>（猪） | 亥卯未月 |',
      '| <b>三月、七月、十一月</b> | <b>巳</b>（蛇） | 申子辰月 |',
      '| <b>四月、八月、十二月</b> | <b>辰</b>（龙） | 巳酉丑月 |',
      '<b>从起点开始，阳遁顺排、阴遁逆排</b>，依次铺十二个字。',
      '<b>举一个例</b>：八月起课 —— "四八十二在龙江"，从<b>辰</b>起；盘上写的是阴遁 —— 那就<b>逆着排</b>。先找到辰在九宫的位置，从辰开始逆铺十二字，铺完对照检查一遍。',
      '<b>这一法用的是月份。</b>',
      '<b style="color:var(--c-gold)">三、第二种排法：按日时</b>',
      '<b>从时支的六合起"进"字</b>，再阳顺阴逆铺十二字。',
      '六合是：<b>子丑合、寅亥合、卯戌合、巳申合、午未合、辰酉合</b>。',
      '<b>举一个例</b>：盘上的时支是<b>酉</b> —— 酉与<b>辰</b>合 —— 那就从<b>辰</b>起进字；盘是阴遁 —— <b>逆排</b>，逆时针铺一圈。',
      '<b>这一法最常用，也最方便</b>，因为它是跟着当下的时辰走的，<b>应事快</b>。',
      '<b style="color:var(--c-gold)">四、两种排法的分别</b>',
      '<b>按月的是长局，按日时的是短局。</b>',
      '奇门解决的是当下的问题，所以<b>长期局的效果会弱一些</b>。日常断事、布局，用第二种居多。',
      '<b style="color:var(--c-gold)">五、四维宫四个字怎么排</b>',
      '十二字沿十二地支铺了一圈，<b>剩下的四个字排在四维宫</b> —— 乾、艮、巽、坤。',
      '<b>排法以天冲星为起点，阳顺阴逆</b>：',
      '<b>天冲星在震三宫</b>，盘是<b>阴遁</b> → 逆排 → 从<b>艮宫</b>起：<b>艮=雷、乾=火、坤=风、巽=豹</b>',
      '<b>天冲星在震三宫</b>，盘是<b>阳遁</b> → 顺排 → <b>巽=雷、坤=火、乾=风、艮=豹</b>',
      '<b>天冲星本身就落在四维宫</b> → <b>该宫排第一个字</b>，再按阳顺阴逆排其余三个。比如天冲星在艮宫，就把<b>雷</b>排在艮宫；阳遁则<b>火</b>排巽宫，依次顺下去',
      '---',
    ]},
    { t: '第二节　十二字像义', rows: [
      '<b>十二个字本身就很形象</b> —— 这是外盘能"一眼直断"的原因。看到哪个字，先出它的本象，再结合宫内原有的星、门、神、干去细化。',
      '<b style="color:var(--c-gold)">一、进</b>',
      '<b>本义</b>：进帐、招财、加官进爵、添人丁；进步、有上进心。',
      '<b>断局</b>：',
      '<b>进字落宫里有戊</b>（天盘干、地盘干、遁干都算），或者<b>宫里有生门</b> → <b>进财</b>',
      '<b>宫里有开门</b> → 工作有发展、加官进爵；开门也主店铺，<b>临进字主可以开分店</b>、门面好',
      '<b>时干</b>（也代表孩子或孩子的年命）<b>临进字</b> → 学习进步',
      '<b>进字的方位，就是家里入户门的位置</b> —— 用该宫内的象意，可以断进门处的情况',
      '<b>临进字的地方主"能进能出"</b> → 人多、进进出出、关卡、十字路口、红绿灯、热闹处、连锁店',
      '<b>死门临进字</b>（八神是腾蛇）→ 坟里进了蛇；<b>临玄武</b> → 坟里进了老鼠',
      '<b>入户门方位若有白虎或伤门</b> → 这个门纳的是病灾之气，主病灾、伤灾、官司口舌',
      '<b>布局</b>：',
      '<b>催丁</b>：让进字临<b>丁</b>，或让进字临年命的<b>十二长生胎地</b>',
      '<b>催财</b>：进字宫内有戊或有生门，都可以用进字布招财局（具体见第五节的布局实务）',
      '<b style="color:var(--c-gold)">二、曲</b>',
      '<b>本义</b>：曲折、伤心、分手、弯曲。',
      '<b>断局</b>：',
      '<b>六合临曲字</b> → 婚姻感情波折、不幸福；六合也主合作，<b>合作临曲字主合作不顺、一波三折</b>',
      '<b>开门临曲字</b> → 工作不顺利、有曲折，也可能调动',
      '<b>值符加曲字</b> → 高管、领导、管理层处境困难',
      '<b>时干临曲字</b> → 事情进展有难度、不顺利',
      '<b>方位环境</b>：弯曲的地方、林荫小道、曲径通幽',
      '<b>布局</b>：<b>曲字可布文昌局</b> —— 它代表<b>文曲星</b>。让<b>景门临曲字</b>，再去生孩子的年命；若能同时把孩子的年命放进局里更好。',
      '<b>这个字也说明一件事</b>：<b>每一个字都有两面性</b>，不能说哪个字好、哪个字坏，要看用在什么地方。',
      '<b style="color:var(--c-gold)">三、狱</b>',
      '<b>本义</b>：牢狱、被困、孤单。',
      '<b>断局</b>：',
      '<b>时干或孩子年命临狱字</b> → 孩子可能自闭，或内心孤单',
      '<b>六合临狱字</b> → 婚姻不好，"婚姻像在牢狱里一样"',
      '<b>值符加狱字</b> → 领导被困，或有被抓之象；也主领导管理严格',
      '<b>生门临狱字，或戊临狱字</b> → 资金被套牢',
      '<b>天辅星</b>（代表老师）<b>临狱字</b> → 老师对学生严格，甚至打骂',
      '<b>临狱字的人</b> → 可能有自闭、孤独、傲慢的性子',
      '<b>方位环境</b>：此方位比较偏僻',
      '<b>狱也主"收藏"</b> —— 若宫内有<b>乙</b>（木）、又有<b>天英星</b>（主桃花）→ <b>金屋藏娇</b>之象',
      '<b>狱也主暗恋</b> —— 若有美女的年命临狱字来生你，主此人暗恋你',
      '<b>布局</b>：<b>孩子多动、调皮</b> → 让孩子的年命临狱字，就不那么调皮了。',
      '<b style="color:var(--c-gold)">四、丰</b>',
      '<b>本义</b>：丰满、丰收、收获；人多的地方、人气旺的地方。',
      '<b>断局</b>：',
      '<b>丰临开门、临时干</b> → 公司员工多，或店铺人流、客流量大',
      '再从宫内细分：<b>临阴星 → 女员工多；临阳星 → 男员工多；临年干 → 年纪大的人多</b>',
      '<b>生门临丰，或戊临丰</b> → 钱多；<b>时干临丰</b> → 客户多',
      '<b>丰的方位</b> → 人多的地方：超市、电影院、会场',
      '<b>时干＋天芮星＋丰字</b> → 这家医院或诊所病人多；<b>宫内再有年干</b> → 病人以老年人居多',
      '<b>布局</b>：',
      '想<b>丰胸</b> → 用丰字设局：<b>戊代表乳房，加丰字，落在震宫</b>',
      '店铺、饭店设局可用丰字',
      '<b>聚宝盆、发财树</b>可以放在丰的位置上',
      '<b>股票临丰字</b>，上涨的可能性大',
      '<b>择日</b>：可选丰字落宫的那一天去开业、去种庄稼',
      '<b style="color:var(--c-gold)">五、空</b>',
      '<b>本义</b>：空地、空欢喜、一场空、没有结果。',
      '<b>断局</b>：',
      '<b>空临生门或戊</b> → 财空了；<b>店铺临空</b> → 人流少',
      '<b>方位环境</b>：空荡荡的，可能有大的空地、操场',
      '<b>六合临空</b> → 婚姻有名无实，或感情没有结果',
      '<b>人的年命临空</b> → 此人比较佛性',
      '<b>布局</b>：',
      '<b>打坐、练功、放空自己</b> → 到空的方位上去，更容易静下来',
      '<b>斩桃花</b> → 在空的方位布局，或<b>把第三者的年命放到空的宫位上</b>',
      '<b style="color:var(--c-gold)">六、泣</b>',
      '<b>本义</b>：哭泣、伤心、流泪、胆小。',
      '<b>断局</b>：',
      '<b>时干或孩子年命临泣字</b> → 孩子胆小、爱哭',
      '<b>女人年命临此字</b> → 多愁善感、有同情心',
      '<b>天芮星临泣字</b> → 病不好治，有卧床之象',
      '<b>开门临泣字</b> → 工作辛苦；开门也主店铺，主经营辛苦',
      '<b>生门加泣字</b> → 生活辛酸',
      '<b>六合临泣字</b> → 婚姻不幸福',
      '<b>乙木临泣字</b> → 花要常浇水',
      '<b>癸水</b>（代表眼睛）<b>临泣字</b> → 有风流眼，见风流泪',
      '<b>方位环境</b>：医院、药店、殡仪馆',
      '<b>布局</b>：<b>泣字临戊 → 不宜投资</b>，容易受到伤害。',
      '<b style="color:var(--c-gold)">七、欹</b>',
      '<b>本义</b>：第三者、三角恋。也主烂桃花、小人、不公正。',
      '<b>断局</b>：',
      '<b>六合临欹字</b> → 婚姻有第三者，不幸福，有分手的可能',
      '<b>学生临欹字</b> → 早恋',
      '<b>方位环境</b>：娱乐场所、歌厅、酒吧',
      '<b style="color:var(--c-gold)">八、劫</b>',
      '<b>本义</b>：劫财、破财；抢劫、打劫。',
      '<b>断局</b>：',
      '<b>劫临戊、生门</b> → 劫财、破财',
      '<b>生门临劫</b> → 骗财；<b>开门临劫</b> → 忽悠、虚假信息',
      '<b>景门</b>（主信息）<b>临劫</b> → 信息有误、信息诈骗',
      '<b>劫也主</b>：脾气不好、打斗、没收、不安全的地方',
      '<b>时干或孩子年命临劫</b> → 喜欢武术、跆拳道；劫也代表保安、城管',
      '<b>六合临劫</b> → 劫色、第三者、烂桃花、横刀夺爱',
      '<b>劫字生女方年命、或生乙木</b> → 会把女方劫走',
      '<b>劫加天蓬星或天英星</b>（天英主桃花）→ 容易劫色',
      '<b>劫临戊</b> → 劫财；也主此人小气、爱占便宜',
      '<b>六合临劫加伤门</b> → 婚姻中会动手、有家暴；<b>加惊门</b> → 吵架；<b>临白虎</b> → 有暴力倾向',
      '<b>年命或时干临劫</b> → 孩子容易欺负别人',
      '<b>布局</b>：',
      '<b>卖房、转租</b> → 用<b>时干临劫</b>来布局，让房子或店铺被"劫走"',
      '思路是：<b>时干（客户）加劫去生开门（店铺）</b> —— 客户把店铺劫走，即转卖或转租出去。<b>劫字也可代表二手房、二手车</b>',
      '<b>斩桃花</b> → 用劫字去生第三者的年命，把第三者劫走',
      '<b>避让</b>：劫与散同宫时，若不想让事情散了，可用<b>劫字所在的地支、及其对冲地支的时间</b>去布局，避开散字',
      '<b style="color:var(--c-gold)">九、散</b>',
      '<b>本义</b>：散漫、好动；散财。',
      '<b>断局</b>：',
      '<b>散临戊或生门</b> → 散财、破财、爱花钱、大手大脚',
      '<b>时干临散</b> → 客户舍得花钱；<b>时干临杜门</b> → 不舍得花钱',
      '<b>六合临散</b> → 感情容易离婚、分手；也可能是<b>分居、分床而睡</b>',
      '<b>临散的人</b> → 没有上进心；<b>孩子临散</b> → 注意力不集中',
      '<b>开门临散</b> → 店铺可能分散、开分店、开连锁',
      '<b>散也主</b>：广告、传媒、散播；拆迁、散步、散伙',
      '<b>临散的人</b> → 喜欢分享、容易付出、可能爱做慈善',
      '<b>布局</b>：',
      '<b>促销</b> → 让<b>客户（时干）临散去生开门</b>，客户到店里就愿意花钱',
      '<b>宣传</b> → 用散字设局，扩大宣传',
      '<b>种庄稼</b> → 在散的日子去撒种子，散播开来',
      '<b style="color:var(--c-gold)">十、破</b>',
      '<b>本义</b>：破损、破灭、破坏。',
      '<b>断局</b>：',
      '<b>破临六合</b> → 婚姻破灭、合作破灭',
      '<b>破加戊或生门</b> → 破财',
      '<b>破加开门</b> → 工作方面有错误、不完美；<b>开门临破</b> 也可主破产',
      '<b>惊门加破</b> → 骂人',
      '<b>房子临破字</b> → 破旧、环境不好',
      '<b>孩子临破字</b> → 调皮、爱搞破坏',
      '<b>年命加破</b> → 主死亡；<b>破字也可代表殡仪馆</b>',
      '<b>方位环境</b>：有破损的东西',
      '<b>布局</b>：',
      '<b>破别人的法</b> → 用破字设局，或在破的方位设局',
      '<b>斩桃花</b> → 让<b>六合临破</b>，或<b>六合临散</b>，都可以',
      '<b style="color:var(--c-gold)">十一、灵</b>',
      '<b>本义</b>：悟性好、有灵感、有灵性。',
      '<b>断局</b>：',
      '<b>景门加灵</b> → 有灵性',
      '<b>临灵字的人</b> → 点子多、有悟性；也可代表玄学',
      '<b>孩子临灵</b> → 聪明，学东西灵活',
      '<b>灵也主</b>：有灵气；贵人、老板、神佛、官贵',
      '<b>布局</b>：',
      '<b>学习</b> → 到灵的方位去学',
      '<b>做法</b> → 到灵字的位置去做法',
      '<b>打坐</b> → 除了空字，也可以到灵字的地方打坐',
      '<b style="color:var(--c-gold)">十二、吾</b>',
      '<b>本义</b>：<b>吾就是求测人本人。</b>',
      '<b>断局</b>：',
      '<b>宫里有白虎</b> → 求测人有灾',
      '<b>宫里有休门</b> → 有贵人帮助',
      '<b>临开门</b> → 此人比较开朗',
      '<b>吾字要结合宫内的信息来断</b> —— 它是把这一个宫的信息"贴到求测人身上"。',
      '<b style="color:var(--c-gold)">一个例子：吉凶怎么看</b>',
      '<b>盘内的信息很好、外盘却临了破字或散字</b> —— 这种怎么断？',
      '<b>按不吉断。</b>',
      '比如说，给人家布局，看那个方位很好，生门又有戊，就布了；布完发现效果不大。再排上外盘一看，<b>外盘临了破字或散字</b> —— 原来此方位"破财"。',
      '<b>这就是外盘的好处：它多给了一层吉凶的判定，给了一个大的方向。</b>',
      '---',
    ]},
    { t: '第三节　四维宫四字', rows: [
      '<b>这四个字排在四维宫</b>（乾、艮、巽、坤），排法见第一节之五。',
      '<b style="color:var(--c-gold)">一、雷</b>',
      '<b>本义</b>：声音、响亮；有名望、有名气、有名声；一鸣惊人。也主有声响的、吵闹的地方。',
      '<b>断局</b>：',
      '<b>临开门或临时干</b> → 店铺比较有名气，或产品众所周知',
      '<b>六合临雷</b> → 婚姻可能有争吵',
      '<b>布局</b>：',
      '<b>布文昌局</b> → 雷主"一鸣惊人"，用它布文昌局，再结合宫内的信息',
      '<b>修雷法</b> → 到雷的宫位、或雷所生的宫位去修法做法',
      '<b style="color:var(--c-gold)">二、火</b>',
      '<b>本义</b>：一切与文化、传媒、媒体有关的行业；红红火火。',
      '<b>断局</b>：',
      '<b>六合临火</b> → 两人正在热恋，干柴烈火',
      '<b>年命临火</b> → 性子急、风风火火',
      '<b>测疾病</b> → 肝火旺、有炎症、发烧',
      '<b>火的方位</b> → 可代表厨房的信息',
      '<b>火是炎上的</b> → 也主事情正在发展、进步当中',
      '<b>布局</b>：<b>这是一个思路</b> —— 测病一般看天芮星。若<b>天芮星落在金的宫位</b>（比如乾宫），而该宫<b>临了火字</b>，火就能克这个金宫；在这个宫位上调病，就可以克制住疾病。',
      '<b>这一条要举一反三</b> —— 不要生搬硬套，把"用外盘的字去生克病星"这个思路，用到别的布局上去。',
      '<b style="color:var(--c-gold)">三、风</b>',
      '<b>本义</b>：传播、宣传、广告；快速。也主不稳定、不确定、墙头草。',
      '<b>断局</b>：',
      '<b>风临六合</b> → 这段感情来得快、去得也快',
      '<b>年命临风</b> → 做事风风火火，也可能像墙头草一样犹豫不决',
      '<b>测疾病临风</b> → 流行病、感冒、风寒、风湿',
      '<b>风也主消息、信息</b> —— 若<b>临腾蛇、玄武</b>，这个消息可能是假的、不真实的',
      '<b>方位环境</b> → 可能有风扇、空调这类物品',
      '<b>布局</b>：<b>做宣传、做销售</b> → 到风的宫位去布。',
      '<b style="color:var(--c-gold)">四、豹</b>',
      '<b>本义</b>：与白虎同类 —— 凶猛、不吉；凶灾、伤灾。也主黑社会、公检法。',
      '<b>断局</b>：',
      '<b>此人的性格</b> → 可能有点凶',
      '<b>六合临豹</b> → 可能有家暴',
      '<b>测衣服</b> → 可能穿豹纹的衣服',
    ...
    { t: '第四节　布局实务', rows: [
      '<b>这一节把两天课里讲到的操作细节归拢起来</b> —— 这些多数是从问答里来的，所以散在讲课时各处，这里集中说。',
      '<b style="color:var(--c-gold)">一、布局的时间怎么选</b>',
      '<b>三个可选的时间</b>：',
      '<b>宫位时间</b> —— 比如巽宫，用<b>辰时、巳时</b>',
      '<b>对宫时间</b> —— 巽宫对面是乾宫，用<b>戌时、亥时</b>',
      '<b>当下的时间</b> —— <b>这是实践中最有效的</b>',
      '<b>为什么当下最好</b>：<b>在此刻的时辰里，星、门、神、值符、值使都在位</b>。',
      '<b>所以选局要往后选，不选过去的局</b> —— 比如选三天以后、七天以后的局，到那个时间再去布。奇门有一千零八十局，过去有人专去那一千零八十局里找，但<b>很多是过去时的局</b>，<b>实践中发现当下的局最好</b>。',
      '<b>操作</b>：可以每两个小时看一次局，往后选，挑出进字临戊或临生门的局，到那个时辰再去布置。',
      '<b>另外</b>：',
      '<b>选明天的局，就在明天那个时辰布</b>，不要提前也不要错后',
      '<b>同一个时辰不能布多个局</b> —— 磁场会乱。但<b>两层楼、两个卧房各布一个是可以的</b>',
      '<b>不用真太阳时</b> —— 统一用北京时间。给国外的人布局，也是用北京时间起局，再换算成当地时间',
      '<b style="color:var(--c-gold)">二、放什么、放多少</b>',
      '<b>取象的三个来源</b>：<b>星、门、神</b> 与 <b>天干、地支、遁干</b> —— <b>任取三个就可以了</b>，不必求全。',
      '<b>最常见的招财局</b>：',
      '<b>戊代表钱</b> —— 最直接。戊在巽宫（巽为4）可以放<b>400 元</b>；天柱星主7，也可以放<b>700 元</b>；艮宫为8，可以放<b>800 元</b>',
      '若现金数额凑不上宫位或星数，<b>宁可不放现金，改用银行卡</b> —— 银行卡同样代表戊',
      '<b>丁代表打火机</b>，也代表红色、代表银行卡',
      '<b>一定要写一个"进"字</b>放在那里（纸的颜色不用参考宫内信息；黄纸黑字可以）',
      '<b>银行卡</b>可配合任何招财局 —— 中国银行的卡最好，因为它最大，也代表值符',
      '<b>如果没有戊，有生门一样可以布财局</b>，按宫内信息取象：',
      '| 宫内 | 可以放 |',
      '|---|---|',
      '| <b>乙木加生门</b> | 真花 |',
      '| <b>再临六合</b> | 百合花 |',
      '| <b>癸水</b> | 红酒 |',
      '| <b>壬水</b> | 矿泉水 |',
      '<b>数量参考星数</b> —— 但不必死板：临天任星主8，<b>放一瓶红酒也可以</b>。',
      '<b>高低</b>：<b>九天、值符 → 放高处；九地 → 放低处；太阴 → 放阴暗处</b>。没有这些特别信息，正常放即可。',
      '<b>找不到对应物象时</b>：<b>星门神和天干地支，取三个即可</b>。比如用打火机、银行卡、人民币，再加一个"进"字。',
      '<b style="color:var(--c-gold)">三、一个局最多动三个宫</b>',
      '<b>一个布局最多涉及三个宫。</b>',
      '有些布局本身就要两三个宫配合 —— 比如讨债局：<b>让欠钱人的年命去克戊</b>（他才会往外拿钱），<b>再让戊来生着我</b>，同时<b>欠钱人的年命宫要生我的年命宫</b> —— 这就涉及三个宫。',
      '<b>但不能再多。</b> 残版有人给客户布局，拉一个 PPT 让人家这里拆、那里移，九个宫几乎全动了 —— <b>九个宫都动，等于一个都没动</b>。',
      '<b style="color:var(--c-gold)">四、年命怎么入局</b>',
      '<b>快速定年命</b>：<b>1辛、2壬、3癸、4甲、5乙、6丙、7丁、8戊、9己、0庚</b>（按出生年份尾数）。',
      '<b>布局的宫里如果有自己的年命，最好把年命的象意物品也摆出来</b> —— 这样就等于你自己也在局里了。',
      '<b>同一个宫里出现几个年命，就都照顾到</b>：宫里有丁年命、庚年命、戊年命，你是丁年命就把丁的物品体现出来。',
      '<b>谁布局应谁</b>：在家里大太极布局，家里人都有进财的可能；<b>哪一个人的年命在此宫，哪个人更应</b>。',
      '<b style="color:var(--c-gold)">五、有效期与撤局</b>',
      '<b>一般 12 天</b> —— 进财了就可以换局；<b>没效果，12 天左右换一个局</b>',
      '<b>终身局布局可以长期摆放</b>，但效果肯定不如当下的局',
      '<b>单宫布局，不用管空亡</b>；若是用来<b>预测读取</b>，则看<b>填实、冲实的时间应事</b>',
      '<b style="color:var(--c-gold)">六、盘要自己手排</b>',
      '<b>这一派的盘全部手排，不用软件</b> —— 师父从来不用软件，本派有自己的一套排盘方法。',
      '<b>排好后的写法</b>（与传统排法有一处不同）：',
      '<b>遁干写在宫内的右上角</b>，不写在盘外面',
      '盘上照常标注：<b>旬首、值符、值使、马星、空亡、四柱</b>',
      '<b>抄盘时</b>：',
      '<b>四柱一定要抄上</b>',
      '<b>化解用的盘，遁干也要写进宫里</b>',
      '<b style="color:var(--c-gold)">七、几条原则</b>',
      '<b>物品放置期间不要随便动它</b>',
      '<b>布局要符合现实、符合常理</b> —— 移星换斗不是所有的都能移、都能换。比如"门"是不能挪走的',
      '<b>不要把它神化</b> —— 布局解决了当下的问题，后面的事还要靠人为。升官布局成功了，不可能这个局摆着不撤、下次还接着升官，下次要另布',
      '<b>大的根基不动，奇门局也难扭转乾坤</b> —— 比如上千万的官司，根源在祖坟，家族内部又不同意动，那靠一个奇门局去翻盘并不现实',
      '---',
    ]},
    { t: '第五节　化解与符咒', rows: [
      '<b>外盘不只能断，还能化。</b> 化的时候除了用物品布局，还有一套符咒可以配合。',
      '<b style="color:var(--c-gold)">一、玄九令印罡</b>',
      '<b>这一派的符咒，核心是四个字：玄、九、令、印、罡</b> —— 写符时先写这四个字，再跟上<b>需要的那个字</b>。',
      '<b>跟哪个字？跟十二建除字。</b>',
      '<b>建　除　满　平　定　执　破　危　成　收　开　闭</b>',
      '<b>十二个字各有其用</b>，按要化解的事情来取：',
      '| 要化解的 | 用字 | 说明 |',
      '|---|---|---|',
      '| <b>七星灯</b> | <b>闭</b> | 把灯闭上 |',
      '| <b>戊临破字（要破财）</b> | <b>收</b> | 把财收进来 |',
      '| <b>疾病的宫位</b> | <b>除</b> | 把病除掉 |',
      '| <b>两人关系临杜门</b> | <b>开</b> | 打开 |',
      '| <b>想让事情成功</b> | <b>成</b> | 促成 |',
      '| <b>官司</b> | <b>危</b> | 危字在此代表吉祥 |',
      '<b>举例</b>：给一个打官司的人布局 —— 在他布局的<b>对面宫位</b>，让他写"玄九令印罡危"，<b>布局时把符烧掉</b>。烧掉之后<b>冲他的布局宫位，一冲便动</b>，然后布局的宫位再生他的年命，对他有利。',
      '<b style="color:var(--c-gold)">二、符怎么做</b>',
      '<b>两种做法，看用途选</b>：',
      '<b>第一种：装葫芦</b>',
      '<b>长 7cm、宽 3cm 的黄纸</b>，<b>墨书</b>',
      '写上"玄九令印罡"加需要的字',
      '叠好，放进<b>木质的那种真葫芦</b>里',
      '<b>葫芦敞着口，不封口</b>，放在要布局的那个宫位上',
      '<b>第二种：画在宣纸上</b>',
      '<b>32 开宣纸</b>，把局画下来',
      '把"玄九令印罡"加那个字，<b>写在要化解的那个宫位旁边</b>',
      '按第一天教的方法<b>叠好</b>（与七星灯同一叠法），放在那个宫位的方位',
      '<b>写符的规矩</b>：',
      '<b>左边 3 个圈，右边 4 个圈</b>',
      '<b>上实下空</b>（上面的圈是实心，下面的是空心）',
      '<b>从上往下竖着写</b>',
      '<b>不用盖章</b> —— 这一派的符咒都不用盖章',
      '除了装葫芦的用 3×7cm，其余都用 32 开宣纸',
      '<b style="color:var(--c-gold)">三、七星灯</b>',
      '<b>什么是七星灯</b>',
      '<b>天柱星所在的宫位，宫外的遁干是丁</b> —— 这才叫七星灯。',
      '<b>注意</b>：如果宫<b>里面</b>的天盘干、地盘干是丁，<b>不算</b>。必须是<b>宫外</b>那个遁干。',
      '<b>开灯与关灯</b>',
      '<b>坎、艮、震、巽</b>（阳宫）→ <b>开灯</b>',
      '<b>离、坤、乾</b>（阴宫）→ <b>关灯</b>',
      '<b>七星灯喜欢关着</b>，所以落在阴宫时力量会减弱 —— 但<b>终归还是不好</b>。',
      '<b>断法</b>',
      '<b>终身局里出现七星灯 → 主短寿，或身体不好。</b>',
      '验证过的例子：十几岁脑梗偏瘫的、三十多岁手术开刀的、抑郁症自杀的。<b>不论开灯关灯，都出过事。</b>',
      '如果此宫里<b>有杜门</b>，会<b>减弱</b>七星灯的力量。',
      '<b>化解</b>',
      '<b>32 开宣纸、朱砂</b>',
      '在纸上<b>画出整个盘</b>',
      '在七星灯那个宫位<b>外面</b>，用朱砂写 <b>"玄九令印罡闭"</b>',
      '叠好，<b>放在枕头下或随身带</b>',
      '<b>一年之后烧掉</b>',
      '<b>要点</b>：',
      '<b>要带够一年</b>才能化解，之后就不用再带了',
      '有人问"化解后能延寿几年" —— <b>在没有发凶之前用了这个方法，到现在没有发凶</b>，这就是它的作用',
      '<b>不是所有的病都能靠它化解</b>',
      '<b style="color:var(--c-gold)">四、皇帝出宫</b>',
      '<b>什么是皇帝出宫</b>',
      '<b>四维宫（乾、艮、巽、坤）同时出现木的信息</b> —— 天冲星、天辅星、伤门、杜门、值符、六合、甲乙木，这些都属木。几个木同时出现在四维宫，就叫<b>皇帝出宫</b>。',
      '<b>断法</b>',
      '<b>终身盘里出现皇帝出宫，同样主短寿。</b>',
      '<b>这个格局很少见</b> —— 身边很少有人有。<b>张雨生、张国荣的八字里就有。</b>',
      '古书里写过"皇帝出宫"这个名字，<b>但光看书没人懂是什么意思</b>。它同样适用于现代的生活与社会。',
      '<b>化解</b>',
      '<b>用土的符咒泄木。</b>',
      '几条要点：',
      '<b>用泄，不用克</b>',
      '<b>土的力量比火大</b> —— 所以用土符，不用火符',
      '<b>画符时，最上端的"土"字不用写</b>',
      '<b>32 开宣纸墨书</b>，画好后按叠法叠好，<b>随身携带一年</b>',
      '<b style="color:var(--c-gold)">五、化白虎</b>',
      '<b>用红笔在纸上画这个符号</b>，画好后<b>放到白虎所在宫位的方位上</b>。',
      '<b>这一招很实用</b>：曾有一位同行给别人化白虎，<b>那个人从 ICU 转到了普通病房</b>。',
      '---',
    ]},
    { t: '第六节　治病一法（天心水）', rows: [
      '<b>这是课后送的一个方法，简单、直接。</b>',
      '<b style="color:var(--c-gold)">一、做法</b>',
      '<b>倒一杯水，放在天心星的宫位上</b> —— <b>放该宫后天八卦数的分钟数</b>（乾6、震3、巽4……比如天心星在乾宫就放 6 分钟）',
      '<b>然后把水拿到"克天芮星的那个宫位"的方位去喝</b>',
      '<b>喝几口，看该宫星的数</b> —— 天柱星喝 7 口，天任星喝 8 口，<b>小口喝</b>',
      '<b>在起局的时辰喝</b> —— 巳时起的局就在巳时喝，午时起的局就在午时喝',
      '<b>连喝三天，三天都按第一天的时间喝</b>',
      '<b>纸杯里剩一点水倒进卫生间，纸杯扔掉</b>',
      '<b>慢性病想长期喝，就每天起局</b>，按当天局显示的来。',
      '<b>可以叠加</b>自己的咒语、剑指等各种加持 —— <b>不冲突</b>。',
      '<b>只用天心星</b> —— 它代表医药。别的星不用。',
      '<b style="color:var(--c-gold)">二、几个要点</b>',
      '<b>"克天芮星的宫位"怎么找</b> —— 指的是<b>宫与宫之间的五行相克</b>：',
      '比如天芮星在<b>震宫</b>（木），<b>金克木</b>，那么<b>兑宫和乾宫</b>都可以克它 —— <b>去正西或西北喝</b>。',
      '<b>如果克天芮的宫位有两个</b> → 结合宫内的信息权衡用哪个。',
      '<b>大小太极都可以用</b>；<b>远程起卦也可以用</b>；<b>不需要结合外盘</b>。',
      '<b>效果</b>：有人发烧、拉肚子，都用这个方法治过。<b>讲课的人自己生病三天吃药没好，上午喝了水，下午就好了。</b>',
      '---',
    ]},
    { t: '第七节　案例', rows: [
      '<b style="color:var(--c-gold)">一、超市转让：一个完整的断盘示范</b>',
      '<b>背景</b>',
      '一位女士问：<b>她想在春节前把店铺兑出去</b>，请给些建议。',
      '她的店是<b>私立学校里的超市</b>。学校很偏僻、学生住宿，日常用品大多在校内买。她通过关系在校内开了<b>两家超市中的一家</b>，另一家是竞争对手。因为学校偏僻、又是住宿制，两家的生意都不错 —— 她<b>每年纯利一百多万</b>。',
      '<b>起局</b>：<b>伏吟局</b> —— 主不动。所以第一句就告诉她：<b>这个店不好往外兑。</b>',
      '<b>当时的对话</b>（课上的原始记录）：',
      '她问：「春节前我愁把店出兑，你能给我点建议不？」',
      '我答：「你们那学校里面就那么一两家，应该好往外兑吧？但是我奇怪，看好像不太容易马上兑出去。<b>而且你剩的货还挺多的</b>，应该还压了一部分钱。」',
      '她说：「因为今年生意特别不好，我本来以为能好兑，<b>结果有传言后年学校有变动</b>。」',
      '—— 这一段正好说明<b>"丰"字怎么看货</b>：时干在坎宫临丰，第一句就断出"货还剩挺多、压了一部分钱"。',
      '<b>断盘过程</b>',
      '<b>看货</b> —— <b>时干代表店铺</b>。时干甲戌己落在<b>坎宫</b>，<b>临"丰"字</b> —— <b>丰主丰满、货多</b> —— 所以断<b>她店里货还剩挺多</b>。',
      '<b>看她本人的状态</b> —— <b>年命癸水临"泣"字</b> —— 泣主伤心、多愁善感。<b>六合宫临空亡，又临"散"和"劫"</b> —— 六合主婚姻，所以问她<b>是不是在婚姻上有什么想法</b>。',
      '她回答：<b>每天都犯愁，确实不想过了。</b>',
      '<b>看钱去哪了</b> —— <b>坤宫的戊临"劫"字</b> —— 戊是钱，劫是劫走 —— 所以问她：<b>另外那一家生意是不是比她好？</b> 因为竞争对手把她的钱劫走了。',
      '<b>看破损</b> —— <b>离宫临"破"字</b> —— 破主破损 —— 所以问她<b>店里正南方是不是有破损的东西</b>。',
      '她第二天回复：「<b>正南是跟隔壁的间壁墙上，有窟窿，耗子打的洞</b>，然后我家这边用<b>石头和板子</b>挡上了。」',
      '—— 这一句把两个象都坐实了：<b>"破"字应"窟窿"</b>，而离宫里的<b>庚</b>应"<b>石头</b>"。',
      '<b>看门</b> —— <b>进字的地方就是入户门</b>，那里<b>临伤门</b> —— 所以问她<b>店铺的门是不是有坏的</b>；也可能是<b>又买了一辆车</b>（进也主"添"，伤门主车）。',
      '<b>看她老公</b> —— 她年命是癸，<b>戊癸相合</b>，所以用<b>戊</b>代替她老公。这个戊<b>临散和劫</b> —— 散主散漫、劫主劫财，所以断她老公<b>比较能花钱</b>。',
      '我当时已经看出来<b>是她老公劫了她的财</b>，所以特意追问了一句："<b>莫名其妙的没了</b>是什么意思？"',
      '她说：<b>她老公做假账，欺骗她。</b> 局上确实如此 —— 她老公临劫字又临戊，把她的财劫走了。',
      '<b>看阴宅</b> —— <b>死门代表坟墓，临六合</b> —— 六合主合 —— 所以断<b>她老公家的坟是合葬坟</b>；<b>临马星主动</b> —— 可能<b>迁移过，或者以后会迁</b>；<b>空亡</b> —— <b>地气空了</b>，而且有破损的地方。',
      '<b>看性格</b> —— 她老公临<b>散</b>字 —— 断他<b>散漫、缺少上进心</b>。',
      '她回答：「就是看够他<b>那一副懒散的样子</b>。」又说：「<b>我常年不去店里，他一直在店里</b>」「<b>我们长期不在一起</b>」—— <b>"散"字在婚姻上的两层（散漫、分居）全都应了</b>。',
      '<b>看有没有外情</b> —— 她老公的<b>坤宫生兑宫</b>，而兑宫<b>临"欹"字</b>（欹主第三者）；<b>六合宫里有寄宫</b> —— 所以问她：<b>不怕老公外面有人吗？</b>',
      '她反问："有吗？" 我说没有 —— <b>但实际上我认为有</b>。',
      '理由：<b>欹字临太阴</b> —— 太阴主暗，说明<b>第三者在暗处、还没被发现</b>；<b>两个人都临空亡</b>，现在还不容易被发现。而且<b>她老公的遁干就是兑宫的壬水</b>，遁干壬水与坤宫地盘干<b>丁壬相合</b>，又为寄宫 —— 所以判断<b>她老公是有第三者的</b>。',
      '<b>这一课的价值</b>',
      '它示范了外盘断盘的完整走法：<b>先看时干定事体，再看年命定人，然后逐宫找字，一个字一条断语，最后把几宫的信息串成一条线</b>。',
      '<b style="color:var(--c-gold)">二、招财局：一个福利局</b>',
      '<b>背景</b>：课上当时的福利局 —— 殿主来说的时候，<b>还剩 7 分钟到 7 点</b>，这个局就过去了。',
      '<b>看局</b>：<b>进字在巽宫，临戊</b> —— 进字宫内有戊或有生门，都可以布招财局。',
      '<b>布法</b>：',
      '<b>钱</b>：巽为4 → 放 <b>400 元</b>；天柱星主7 → 也可以放 <b>700 元</b>',
      '<b>位置</b>：临<b>太阴</b> → 放在<b>阴暗的角落</b>；又临<b>杜门</b> → 最好放在<b>角落里看不见的地方</b>',
      '<b>丁</b>代表<b>打火机</b>，也代表<b>红色</b> → 可以放<b>红色的打火机</b>',
      '<b>银行卡</b> → 中国银行的卡最好，它最大，也代表值符',
      '<b>一定要在纸上写一个"进"字</b>，和这些物品一起放到方位上',
      '<b>时间</b>：可以用<b>巽宫的辰时、巳时</b>，或者<b>对宫的戌时、亥时</b>；也可以<b>就在当下</b>（这个局是酉时，即 17—19 点）—— <b>当下最好</b>。',
      '<b style="color:var(--c-gold)">三、第一个财局：进账六千八</b>',
      '<b>这是学完十六字诀之后布的第一个财局。</b>',
      '<b>局的构成</b>：<b>艮宫</b>，宫里有<b>九天、生门、遁干戊、乙木、丙火</b>。',
      '<b>布法</b>：',
      '<b>生门临乙木</b> → 用<b>百合花</b>',
      '<b>九天</b> → 放在<b>很高的地方</b>',
      '<b>丙</b> → 用<b>红色的陶瓷花瓶</b>，把百合花插进去',
      '写一个<b>进</b>字',
      '放在家里很高的位置上',
      '<b>时间</b>：艮宫对应寅，所以他在<b>寅时</b>布的局 —— 那时候还没有悟出"用当下的时间"，<b>凌晨三点多起来布的局</b>。',
      '<b>结果</b>：<b>当天上午进账 6800。</b>',
      '后来把这个局分享给一位师妹，她<b>第二天也在寅时布局，同样进账</b>。',
      '<b style="color:var(--c-gold)">四、讨债局：三个宫的配合</b>',
      '<b>背景</b>：有人欠钱不还，<b>而且不承认这笔债</b> —— 因为没有欠条。',
      '<b>布局思路</b>（这个局涉及三个宫）：',
      '<b>让对方的年命去克戊</b> —— 他克着戊，才会往外拿钱（如果戊克着他，他可能没钱还）',
      '<b>让戊来生着我</b> —— 生我，我才能得财',
      '<b>让欠钱人的年命宫生我的年命宫</b> —— 这样两人之间会缓和',
      '<b>结果</b>：<b>再找他的时候，他同意还钱了。</b>',
      '<b>这个例子说明两件事</b>：',
      '<b>一个局最多动三个宫</b> —— 之所以会用到三个宫，是因为这件事本身就涉及三个宫',
      '<b>布局要讲逻辑</b> —— 谁克谁、谁生谁，方向不能搞反',
      '<b style="color:var(--c-gold)">五、反推：从结果倒推该找什么样的局</b>',
      '<b>在实践中积累的一条经验</b>：',
      '有一次布的财局，是<b>景门临天辅星</b>。当时心里想：景门临天辅，<b>会不会是在网络或授课方面进账</b>？后来证明<b>就是在此方面进账</b>。',
      '还有一次是<b>死门</b>的局，当时想：<b>会不会是在法事上进的账</b>？结果<b>就是在做法事上面进的账</b>。',
      '<b>所以可以反过来推</b>：如果最近要在法事上挣钱，那就去找<b>死门这样的招财局</b>去布。',
      '<b>这就是"举一反三、触类旁通"</b> —— 思路是活的，反过来用也行。',
      '<b>实践出真知。</b>',
    ]},
  ]
};
