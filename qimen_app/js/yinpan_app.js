...
const JK_HELP = {
  ...
  blocks: [
    ...
    { t: '神煞', rows: [
      ...
      '<b>旬</b>：四大空亡、旬空',
      '<b>讲义增补</b>（按讲义原文起例，配套软件无）：<b>驿马</b> —— 申子辰马在寅、亥卯未马在巳、巳酉丑马在亥、寅午戌马在申；讲义称其为「金口诀断课主要神煞」，万事实施需先动，驿马即实施端，被合则不动、逢冲才动。<br><b>桃花</b> —— 申子辰见酉、亥卯未见子、巳酉丑见午、寅午戌见卯，以日为准，其它三支见者即是。<br><b>六害</b> —— 子未、丑午、寅巳、卯辰、申亥、酉戌；<b>六冲</b> —— 逢冲必动，冲则散。<br><b>相破</b> —— 子破酉、午破卯、丑破辰。<br><b>四绝</b> —— 寅酉金绝在文道、卯申木绝车马财、午亥水绝因口舌、子巳火绝妇女男，绝有不可挽回之意。<br><b>三奇</b> —— 天三奇甲戊庚、地三奇乙丙丁、人三奇壬癸辛，以年月日时四柱天干及人元、神干、将干同看；遇三奇利见大人、百事吉昌，其中乙丙丁效果最佳。',
      '<b>落位</b>：神煞按四位分 —— 人元位只取天干神煞，地分位只取地支神煞，贵神/将神位干支皆取。',
      '<b>用神（用爻）取法</b>（讲义第四课「用神歌」原文）：<br>      「金口四位干支祥，天干地支定阴阳。<b>课体纯阳神为用</b>，物极必反求事忙。<b>课体纯阴将为用</b>，耐心等待阴返阳。<b>三阳一阴阴为用</b>，前途不明防损伤。<b>三阴一阳阳上取</b>，前途光明莫迟商。<b>二阴二阳将为用</b>，吉凶不定细思量。<br>用神旺相求事吉，休囚死空不当强。四为之中用为帅，吉凶成败问三方。」<br>阴阳按四位的<b>地支</b>论（子寅辰午申戌为阳、丑卯巳未酉亥为阴）。取用范围限于<b>贵神与将神</b>——讲义另言「用神只在贵神将神之间选取」；独阴或独阳若落在人元、地分，则回退为纯阳取贵神、纯阴取将神。<br>若四位阴阳均分（二阴二阳）亦取将神，故吉凶不定需细思量。',
...
function toggleJinKouJue(noScroll) {
  ...
  try {
    ...
    const optStyle = 'margin:0 0 0 4px;width:13px;height:13px;flex:none;accent-color:var(--c-theme);vertical-align:middle';
    const labStyle = 'display:inline-flex;align-items:center;gap:1px;font-size:12px;color:var(--c-text);cursor:pointer;white-space:nowrap';
